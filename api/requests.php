...
if($_SERVER['REQUEST_METHOD'] == 'GET'){
  require_once("controller/get/requests.php");
}

//if you send a new movie name over under the variable movie_name, then I will add a new move to the database
if($_SERVER['REQUEST_METHOD'] == 'POST'){
  require_once("controller/post/requests.php");
}

if($_SERVER['REQUEST_METHOD'] == 'PATCH'){
  require_once("controller/patch/requests.php");
}

if($_SERVER['REQUEST_METHOD'] == 'DELETE'){
  require_once("controller/delete/requests.php");
}
?>